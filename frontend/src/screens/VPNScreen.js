...
return (<div>
        ...
        <h1 className="center">Cómo activar un juego con una key 'AZ Exclusive'</h1>
        <div>
            <p>&nbsp;</p>
            ...
            <p><strong>Leyenda regiones:</strong></p>
            <ul>
            ...
            <p>&nbsp;</p>
            <h2>Paso 4: Login en tu cuenta Microsoft - Steam - PlayStore </h2>
