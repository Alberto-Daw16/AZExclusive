...
return (<div>
        ...
        <br></br>
        <h3>Nuestro Logo</h3>
        <div><Image src="/images/logo.png"/></div>
        ...
        <div><Image src="/images/posicionamiento.png"style={{paddingTop: '80px', paddingBottom: '20px',}}/></div>
        <div>
...
export default ConocenosScreen;
